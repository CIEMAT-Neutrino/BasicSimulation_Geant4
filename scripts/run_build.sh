...
# Set the Geant4 installation directory
Geant4_DIR=/cvmfs/geant4.cern.ch/geant4/latest-ref/x86_64-centos7-gcc8-optdeb-MT/lib64/cmake/Geant4/

# Configure and build the project using CMake
cmake -DGeant4_DIR=$Geant4_DIR -B build/ -DGEANT4_BUILD_MULTITHREADED=ON
cmake --build build/ --config Release -- -j 8 || exit 1
