...
G4bool MySensitiveDetector::ProcessHits(G4Step *aStep, G4TouchableHistory *ROhist)
{
    ...
    if (save_all)
    {
        ...
        if (prevEvent != evt)
        {
            if (DEBUG)
            {
                std::cout << "Event: " << evt << " of " << Nevts << "; prevEvent: " << prevEvent << "; acum_hits: " << acum_hits << " ;sensor:" << sensor << std::endl;
            }
            ...
            if (DEBUG)
            {
                std::cout << "Event: " << evt << " of " << Nevts << "; currentEvent: " << prevEvent << "; acum_hits: " << acum_hits << " ;sensor:" << sensor << std::endl;
            }
        }
